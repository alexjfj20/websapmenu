...
function initPathCorrector() {
  const isProd = process.env.NODE_ENV === 'production';
  let basePath = '/';

  if (isProd) {
    if (window.location.pathname.includes('/websapmenu/')) {
      basePath = '/websapmenu/';
    } 
  ...
  console.log(`✅ Corrector de rutas inicializado (basePath: ${basePath}`);
  return basePath;
}
...
const routes = [
  ...
  },
  {
    path: '/menu/:id',
    name: 'PublicMenu',
    component: () => import(/* webpackChunkName: "public-menu" */ '../views/PublicMenu.vue'),
    props: true
  },
  {
    path: '/superadmin',
